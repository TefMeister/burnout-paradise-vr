...
| --- | --- | --- | --- |
| 2026-08-25 | [Denuvo's 2026 landscape + ScyllaHide](topics/2026-08-25-denuvo-2026-landscape-and-scyllahide.md) | 🆕 new | Denuvo's anti-tamper effectiveness has reportedly collapsed industry-wide by mid-2026; ScyllaHide (x64dbg plugin) is the concrete, legitimate tool to try first for debugger attach against `BurnoutPR.exe`'s confirmed Denuvo protection. |
| 2026-08-25 | [Stereo-3D prior art (HelixMod/3Dmigoto)](topics/2026-08-25-stereo-3d-prior-art-helixmod-3dmigoto.md) | 🆕 new | Original game has a D3D9 HelixMod UI-depth fix; no equivalent exists yet for Remastered's D3D11 build. Confirms 3Dmigoto is the right tool class for camera/cbuffer discovery, but no shortcut — reflection work starts from scratch. |
